        ...
        <section class="section section_main">
            <div class="main-slider js-main-slider">
                <div class="main-slider__item">
                    <div class="wrapper">
                        <div class="main-slider__img img1">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/toy-1.png"
                                 style="transform: translateX(-50px)" alt="">
                        </div>
                        <div class="main-slider__img-bottom">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/zayac.png" alt="">
                        </div>
                        <div class="main-slider__right">
                            <h1 class="h1">Elen Toys </h1>
                            <div class="h1-descr">любимая игрушка рядом</div>
                            <div class="main-slider__text">Плюшевые игрушки ручной работы по индивидуальному заказу.
                                Внимание к деталям, а так же достоверная схожесть с любимым персонажем.
                            </div>
                            <a href="#" class="btn btn_pink"><span class="btn__icon">.</span>Подробнее<span
                ...
                <div class="main-slider__item">
                    <div class="wrapper">
                        <div class="main-slider__img">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/toy-2.png"
                                 style="transform: translateX(50px)" alt="">
                        </div>
                        <div class="main-slider__img-bottom">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/zayac.png" alt="">
                ...
                <div class="main-slider__item main-slider__item_slide-right main-slider__item_with-bg"
                     data-mob-href="<?php echo get_template_directory_uri(); ?>/assets/img/slide-with-bg.jpg"
                     data-tab-href="<?php echo get_template_directory_uri(); ?>/assets/img/slide-with-bg-tab.jpg">
                    <div class="wrapper">
                        <div class="main-slider__right">
                ...
                <div class="main-slider__item">
                    <div class="wrapper">
                        <div class="main-slider__img">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/toy-3.png" alt=""
                ...
                <div class="main-slider__item">
                    <div class="wrapper">
                        <div class="main-slider__img">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/toy-4.png" alt=""
                                 style="transform: translateX(23px) translateY(80px);">
                        </div>
                        <div class="main-slider__img-bottom">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/zayac.png" alt="">
                        </div>
                ...
                <div class="main-slider__item">
                    <div class="wrapper">
                        <div class="main-slider__img">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/toy-5.png" alt=""
                                 style="transform: translate(127px , 0)">
                        </div>
                        <div class="main-slider__img-bottom">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/zayac.png" alt="">
                        </div>
                        ...
                        <div class="novelty-slider__picture">
								<span class="novelty-slider__round">
									...
									<span class="nov-sl__line2">
										<img src="<?php echo get_template_directory_uri(); ?>/assets/img/slide/el-slide2.png" alt="">
									</span>
								</span>
